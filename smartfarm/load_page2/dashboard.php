                        ...
                        <div class="card-body">
                            <div class="row">
                                <h3 class="card-title col-8">
                                    <B class="text-dark">Voltage <?= $row_41["sensor_imgNor"] ?></B>
                                </h3>
                                <div class="card-title col-4" align='right'>
                                    <a href="javascript:void(0)" class="ico-chart icon_chart" sncanel="<?= $row9["meter_chenal_1"] ?>" mode="<?= $row9["meter_mode_1"] ?>" name="Voltage" house_master="<?= $house_master ?>"><i class="icon-line-chart  m-r-10"></i></a>
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 ">
                    <div class="dashboard m-b-20">
                        <div class="card-body">
                            <div class="row">
                                <h3 class="card-title col-8">
                                    <B class="text-dark">Water Consumption</B>
                                </h3>
                                <div class="card-title col-4" align='right'>
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 ">
                    <div class="dashboard m-b-20">
                        <div class="card-body">
                            <div class="row">
                                <h3 class="card-title col-8">
                                    <B class="text-dark">Wind Speed</B>
                                </h3>
                                <div class="card-title col-4" align='right'>
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 ">
                    <div class="dashboard m-b-20">
                        <div class="card-body">
                            <div class="row">
                                <h3 class="card-title col-8">
                                    <B class="text-dark">Wind Direction</B>
                                </h3>
                                <div class="card-title col-4" align='right'>
                        ...
                        am4core.ready(function() {
                            ...
                            function onMessageArrived(message) {
                                if (message.destinationName == house_master + "/1/data_update/data_filter") {
                                    ...
                                    function show_dash(dstatus, canelsn, canel, snmode) {
                                        var data_dash = data_array[canelsn];
                            ...
                            if (meter_st_5 === "1") {
                                ...
                                series_45.dataFields.valueY = "chart_wt";
                                series_45.dataFields.dateX = "timestamp";
                                series_45.tooltipText = "{chart_wt} ("+unit_m5+")";
